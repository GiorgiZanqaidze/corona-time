<x-layout>
    <x-header infoType="Worldwide Statistics">
        <div class="sm:flex grid grid-cols-2 justify-between mt-10 gap-5">
            <div class="sm:w-1/4 col-span-2 h-60 relative flex justify-center rounded-2xl truncate">
                ...
                <h2 class="absolute bottom-[30%] left-[50%] text-red-500 translate-x-[-50%] opacity-100">New cases</h2>
                <h1 class="absolute bottom-[10%] left-[50%] text-red-500 translate-x-[-50%] opacity-100 text-3xl text-blue font-bold">715,523<h1>
            </div>
            <div class="sm:w-1/4 h-60 relative grid-cols-1 flex justify-center rounded-2xl truncate">
                ...
                <h2 class="absolute bottom-[30%] left-[50%] text-red-500 translate-x-[-50%] opacity-100">Recovered</h2>
                <h1 class="absolute bottom-[10%] left-[50%] text-red-500 translate-x-[-50%] opacity-100 text-3xl text-blue font-bold">715,523<h1>
            </div>
            <div class="sm:w-1/4 h-60 relative grid-cols-1 flex justify-center rounded-2xl truncate">
                ...
                <h2 class="absolute bottom-[30%] left-[50%] text-red-500 translate-x-[-50%] opacity-100">Death</h2>
                <h1 class="absolute bottom-[10%] left-[50%] text-red-500 translate-x-[-50%] opacity-100 text-3xl text-blue font-bold">715,523<h1>
            </div>
        </div>
    </x-header>
