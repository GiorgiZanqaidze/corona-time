    ...
    <x-header infoType="{{__('messages.worldwide_statistics')}}">
        <div class="sm:flex grid grid-cols-2 justify-between mt-10 gap-5">
            <div class="sm:w-1/4 col-span-2 h-60 relative flex justify-center rounded-2xl truncate">
                ...
                <h2 class="absolute bottom-[30%] left-[50%] text-red-500 translate-x-[-50%] opacity-100 text-sm md:text-xl">{{__('messages.new_cases')}}</h2>
                <h1 class="absolute bottom-[10%] left-[50%] text-red-500 translate-x-[-50%] opacity-100 text-xl md:text-3xl text-blue font-bold">{{$confirmed}}<h1>
            </div>
            <div class="sm:w-1/4 h-60 relative grid-cols-1 flex justify-center rounded-2xl truncate">
                ...
                <h2 class="absolute bottom-[30%] left-[50%] text-red-500 translate-x-[-50%] opacity-100 text-sm md:text-xl">{{__('messages.recovered')}}</h2>
                <h1 class="absolute bottom-[10%] left-[50%] text-red-500 translate-x-[-50%] opacity-100 text-xl md:text-3xl text-blue font-bold">{{$recovered}}<h1>
            </div>
            <div class="sm:w-1/4 h-60 relative grid-cols-1 flex justify-center rounded-2xl truncate">
                ...
                <h2 class="absolute bottom-[30%] left-[50%] text-red-500 translate-x-[-50%] opacity-100 text-sm md:text-xl">{{__('messages.death')}}</h2>
                <h1 class="absolute bottom-[10%] left-[50%] text-red-500 translate-x-[-50%] opacity-100 text-xl md:text-3xl text-blue font-bold">{{$deaths}}<h1>
            </div>
        </div>
    </x-header>
</x-layout>