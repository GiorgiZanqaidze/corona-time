        ...
        <div class="min-vh-100 w-35 max-w-30 flex flex-col">
            ...
            <form class="flex flex-col gap-10" method="POST" action="/reset-password">
                ...
                <div class="mb-2 relative">
                    ...
                    <input type="email" id="email" name="email" class="border {{$errors->has('email') ? 'border-error-red' : 'border-borderCl'}} p-3 shadow-sm bg-gray-50 text-gray-900 text-sm rounded-lg focus:ring-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:shadow-sm-light" placeholder="{{__('messages.enter_your_email')}}">
                    @error('email')
